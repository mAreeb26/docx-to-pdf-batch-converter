...
## Requirements
- Python 3.5+
- Microsoft Word(needed by docx2pdf in Windows)
- docx2pdf Python library

## Installation
- make sure you have all the requirements mentioned above
...
- if you have exclusions enetr the names of the files without the `.docx` extension seperated by commas
